...
def run_cmd_command(command):
    """
    Run a command using CMD on Windows systems for simple and predictable execution.
    ...
    # Use CMD directly for Windows
    return subprocess.run(f'cmd.exe /c "{command}"', shell=True)
